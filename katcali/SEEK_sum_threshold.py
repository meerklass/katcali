...
modified to python3 by Jingying Wang <astro.jywang@gmail.com>
'''
...
from . import SEEK_sum_threshold_utils as sum_threshold_utils
from . import SEEK_filter as filter
...
def get_empty_mask(shape):
    #copied from seek/seek/utils/tod_utils.py 
...
def get_rfi_mask(tod, mask=None, chi_1=35000, eta_i=[0.5, 0.55, 0.62, 0.75, 1], normalize_standing_waves=True, suppress_dilation=False, plotting=True, sm_kwargs=None, di_kwargs=None):
    ...
    if not suppress_dilation:
        ...
        dilated_mask = binary_mask_dilation(dilated_mask ^ mask, **di_kwargs) #py2->py3    
