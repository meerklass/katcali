...
def deg_filter(dump, ang_deg_list, sigma_level, n_iter, verbose=True):
    """
    ...
    dump_iter = list(dump)
    if verbose: print('deg filter start: '+str(ang_mean)+'+/-'+str(ang_std))
    ...
    if verbose: print('deg filter end: '+str(ang_mean)+'+/-'+str(ang_std)+'\n')
    return dump_iter
