...
rfi_threshold_json_path = os.path.join(os.path.dirname(__file__), 'KATcali_level1_py3_aoflagger_thresholds.json')
with open(rfi_threshold_json_path) as json_file:
    rfi_threshold_dict = json.load(json_file)
...
if ant in ants_good: 
    try:
        for pol in ['h','v']:
            recv=ant+pol
            Threshold_factor1, Threshold_factor2, Threshold_factor11, Threshold_factor22 = kio.load_rfi_thresholds(
                rfi_threshold_dict=rfi_threshold_dict,
                fname=fname,
                recv=recv
            )
            ...
            del vis_clean
            del vis_clean2
            del vis_clean2_part1,vis_clean2_part2            
            #end
