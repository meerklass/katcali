...
input_file='/scratch3/users/jywang/MeerKLASS2021/level4/re_cali1_round5/'
...
Tresi_recover_map=d1['Tresi_recover_map'] #new added for re-calibration
...
Sum_Tresi_recover_xy=fits_temp.copy()
Npix_xy_count3=fits_temp.copy()
...
for i in range(len(ra)):
    ...
    #new added for re-calibration    
    mask3=Tresi_recover_map.mask[i,:]
    if (mask3==True).all()==False:
        Sum_Tresi_recover_xy[x_pix,y_pix,~mask3]+=Tresi_recover_map[i,~mask3]
        Npix_xy_count3[x_pix,y_pix,~mask3]+=1
        
assert((Npix_xy_count1==Npix_xy_count2).all())

Tsky_xy=Sum_Tsky_xy/Npix_xy_count1
Tresi_xy=Sum_Tresi_xy/Npix_xy_count2
Tresi_recover_xy=Sum_Tresi_recover_xy/Npix_xy_count3  #new added for re-calibration  
...
assert((Npix_xy_count1==Npix_xy_count2).all())
assert((Npix_xy_count1==Npix_xy_count3).all()) #new added for re-calibration  

print (w)

list=[Sum_Tsky_xy,Sum_Tresi_xy,Sum_Tresi_recover_xy,Npix_xy_count1,Tsky_xy,Tresi_xy,Tresi_recover_xy] #new added for re-calibration  
list_str=['Sum_Tsky_xy','Sum_Tresi_xy','Sum_Tresi_recover_xy','Npix_xy_count','Tsky_xy','Tresi_xy','Tresi_recover_xy'] 
